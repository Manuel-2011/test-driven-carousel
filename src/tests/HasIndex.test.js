...
describe('HasIndex()', () => {
  ...
  it('has an initial "index" state of the "defaultIndex" prop', () => {
  ...
  it('allows "index" state to change if the "index" prop is set', () => {
    const wrapperWithInitialIndex = shallow(
      <MockComponentWithIndex index={1} />
    );
  ...
  it('has the max "index" state on decrement function from 0', () => {
